...
//added configurations (MJP)
    ...
    else if (iNumPlayersLandmass1 == 0 && iNumPlayersLandmass2 == 8) {
        //var validConfigs1 = [[0, 2, 3, 5, 6, 8, 9, 11]];
        var validConfigs1 = [[]];
        var validConfigs2 = [[1,3,7,10,14,17,21,23]];
    }

    else if (iNumPlayersLandmass1 == 6 && iNumPlayersLandmass2 == 2) {
        //var validConfigs1 = [[0, 2, 3, 5, 6, 8, 9, 11]];
        var validConfigs1 = [[1,3,5,6,8,10]];
        var validConfigs2 = [[4,7]];
    }
    else if (iNumPlayersLandmass1 == 2 && iNumPlayersLandmass2 == 6) {
        //var validConfigs1 = [[0, 2, 3, 5, 6, 8, 9, 11]];
        var validConfigs1 = [[4,7]];
        var validConfigs2 = [[1,3,5,6,8,10]];
    }
    ...
    else if (iNumPlayersLandmass1 == 0 && iNumPlayersLandmass2 == 6) {
        //var validConfigs1 = [[0, 2, 3, 5, 6, 8, 9, 11]];
        var validConfigs1 = [[]];
        var validConfigs2 = [[1,3,5,6,8,10]];
    }

    else if (iNumPlayersLandmass1 == 8 && iNumPlayersLandmass2 == 3) {
        var validConfigs1 = [[1,3,7,10,14,17,21,23]];
        var validConfigs2 = [[7,16,18]];
    }
    else if (iNumPlayersLandmass1 == 3 && iNumPlayersLandmass2 == 8) {
        var validConfigs1 = [[7,16,18]];
        var validConfigs2 = [[1,3,7,10,14,17,21,23]];
    }

    else if (iNumPlayersLandmass1 == 12 && iNumPlayersLandmass2 == 0) {
        //var validConfigs1 = [[1,23,3,21,10,14,7,17]];
        var validConfigs1 = [[0,1,2,3,4,5,6,7]];
        var validConfigs2 = [[]];
    }
//end additions
...
export function assignStartPositions(iNumWest, iNumEast, west, east, iStartSectorRows, iStartSectorCols, sectors) {
    ...
    //
        ...
        let iLeftCol = 0;
        let iRightCol = GameplayMap.getGridWidth();
        if (bEastBias) {
            iLeftCol = east.west;
            iRightCol = east.east;
        }
        ...
        StartPositioner.divideMapIntoMajorRegions(iNumberHomelands, iMinMajorFertility, iMinMinorFertility, iLeftCol, iRightCol);
        ...
        StartPositioner.divideMapIntoMajorRegions((iMaxNumMajors - iNumberHomelands), iMinMajorFertility, iMinMinorFertility, iLeftCol, iRightCol);
...
// The playerId is the abolute playerId
    ...
    for (let iY = region.south; iY <= region.north; iY++) {
        for (let iX = region.west; iX <= region.east; iX++) {
            ...
            if (score > highestScore) {
                highestScore = score;
                chosenPlotIndex = iY * GameplayMap.getGridWidth() + iX;
            }
        }
    }
